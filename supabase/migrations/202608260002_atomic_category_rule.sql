...
revoke all on function public.set_transaction_category_and_rule(uuid, public.transaction_category) from public;
grant execute on function public.set_transaction_category_and_rule(uuid, public.transaction_category) to authenticated;
