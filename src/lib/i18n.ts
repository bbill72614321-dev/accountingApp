...
export const dictionaries: Record<Language, Dictionary> = {
  en: {
    ...
    spentThisMonth: 'Spent this month', needsReview: 'Needs review', bankPending: 'Bank pending', status: 'Status', currentMonth: 'Current month', previousMonth: 'Newer month', nextMonth: 'Older month', confirm: 'Confirm', ready: 'Ready', manual: 'Manual', imported: 'Imported',
  ...
  'zh-TW': {
    ...
    spentThisMonth: '本月支出', needsReview: '待確認', bankPending: '銀行待入帳', status: '狀態', currentMonth: '本月', previousMonth: '較新月份', nextMonth: '較舊月份', confirm: '確認', ready: '已確認', manual: '手動輸入', imported: '匯入',
