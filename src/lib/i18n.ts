...
export type Dictionary = {
  ...
  reimbursements: string; split: string; editSplit: string; splitPayment: string; splitCount: string; yourShare: string; amountOwed: string
...
export const dictionaries: Record<Language, Dictionary> = {
  en: {
    ...
    reimbursements: 'Reimbursements', split: 'Split', editSplit: 'Edit split', splitPayment: 'Split payment', splitCount: 'People splitting', yourShare: 'Your share',
  ...
  'zh-TW': {
    ...
    reimbursements: '代墊', split: '拆分', editSplit: '編輯拆分', splitPayment: '拆分交易', splitCount: '共幾人分', yourShare: '我實際負擔',
