...
export type Dictionary = {
  ...
  spentThisMonth: string; needsReview: string; bankPending: string; status: string; confirm: string; ready: string; manual: string; imported: string
...
export const dictionaries: Record<Language, Dictionary> = {
  en: {
    ...
    spentThisMonth: 'Spent this month', needsReview: 'Needs review', bankPending: 'Bank pending', status: 'Status', confirm: 'Confirm', ready: 'Ready', manual: 'Manual', imported: 'Imported',
  ...
  'zh-TW': {
    ...
    spentThisMonth: '本月支出', needsReview: '待確認', bankPending: '銀行待入帳', status: '狀態', confirm: '確認', ready: '已確認', manual: '手動輸入', imported: '匯入',
